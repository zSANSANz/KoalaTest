...
type Customer struct {
	...
	CustomerName		string         `gorm:"type:varchar(80);unique;not null" json:"customer_name" form:"customer_name"`
	...
	Password 			string         `gorm:"type:varchar(400);unique;not null" json:"password" form:"password"`
